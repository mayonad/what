...
class RentsControllerTest < ActionController::TestCase
  ...
  test "should create rent" do
    assert_difference('Rent.count') do
      post :create, rent: { bedroom: @rent.bedroom, description: @rent.description, guests: @rent.guests, name: @rent.name, photo: @rent.photo, price: @rent.price, wifi: @rent.wifi }
    end
  ...
  test "should update rent" do
    patch :update, id: @rent, rent: { bedroom: @rent.bedroom, description: @rent.description, guests: @rent.guests, name: @rent.name, photo: @rent.photo, price: @rent.price, wifi: @rent.wifi }
    assert_redirected_to rent_path(assigns(:rent))
  end
